...
router.post('/add',async (req,res)=>{
    ...
    let id=1
    //GeneracionTickets.User;
    const query="INSERT INTO `GeneracionTickets`.`Tickets` (`Number`,`id_User`) VALUES ('"+numero+"','"+id+"')"
    await mysqlConnection.query(query,[numero,id],(err,rows,filds)=>{
        if(!err){
